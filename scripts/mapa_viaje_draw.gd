...
func _draw() -> void:
	#se podría haber puesto un mapa estático con tooodas las ciudades predefinidas, y que solo se ilumine la ciudad acual y la próxima. Pero esta versión nos pareció buena para probar usar el draw.
	if mapa == null:
		return
